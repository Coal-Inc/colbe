...
<header class="fixed top-3 left-1/2 z-50 w-[94%] max-w-6xl -translate-x-1/2 rounded-full border border-zinc-800 bg-zinc-950/90 px-5 py-2.5 backdrop-blur-md">
	<nav class="flex items-center justify-between">
		...
		<div class="hidden items-center gap-1 text-sm text-zinc-400 md:flex">
			<div class="relative">
				<button onclick={() => { products = !products; resources = false; }} class="flex items-center gap-1 rounded-[15px] px-3 py-2 hover:bg-zinc-800 hover:text-white transition-colors">
			...
			<div class="relative">
				<button onclick={() => { resources = !resources; products = false; }} class="flex items-center gap-1 rounded-[15px] px-3 py-2 hover:bg-zinc-800 hover:text-white transition-colors">
			...
			<a href="https://pricing.colbe.cc" class="rounded-[15px] px-3 py-2 hover:bg-zinc-800 hover:text-white transition-colors">Pricing</a>
			<a href="https://about.colbe.cc" class="rounded-[15px] px-3 py-2 hover:bg-zinc-800 hover:text-white transition-colors">About</a>
		</div>

		<div class="hidden items-center gap-2 md:flex">
			<a href="/login" class="rounded-[15px] px-4 py-2 text-sm text-zinc-400 hover:text-white transition-colors">Login</a>
	...
	<div class="mt-3 flex flex-col gap-1 border-t border-zinc-800 pt-3 md:hidden">
		<a href="https://about.colbe.cc" class="rounded-[15px] px-3 py-2.5 text-sm text-zinc-400 hover:bg-zinc-800 hover:text-white">About</a>
