...
<header class="fixed top-3 left-1/2 z-50 w-[94%] max-w-6xl -translate-x-1/2 rounded-2xl border border-zinc-800 bg-zinc-950/90 px-4 py-2.5 backdrop-blur-md">
	<nav class="flex items-center justify-between">
		...
		<div class="hidden items-center gap-1 text-sm text-zinc-400 md:flex">
			...
			<a href="https://pricing.colbe.cc" class="rounded-xl px-3 py-2 hover:bg-zinc-800 hover:text-white transition-colors">Pricing</a>
			<a href="https://about.colbe.cc" class="rounded-xl px-3 py-2 hover:bg-zinc-800 hover:text-white transition-colors">About</a>
		</div>
