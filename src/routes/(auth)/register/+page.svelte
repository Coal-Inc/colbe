...
<div class="flex min-h-screen items-center justify-center px-4">
	<div class="w-full max-w-sm">
		...
		<form class="flex flex-col gap-3">
			<Input type="text" placeholder="Full name" class="rounded-full" />
			<Input type="email" placeholder="Email" class="rounded-full" />
			<Input type="password" placeholder="Password" class="rounded-full" />
			<Button class="rounded-full bg-blue-600 hover:bg-blue-500">Create account</Button>
		</form>
